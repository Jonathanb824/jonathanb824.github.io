...
## Step 1 - Setup
 ...
 - In your bash terminal run the command `npm install --global lodown-jonathanb` with **your** lodown package
 - In your bash terminal run the command `npm link lodown-jonathanb` with **your** lodown package
...
## Step 2 - Solve
 ...
 - To test your solutions run `npm start --prefix ./jonathanb824.github.io/projects/let-s-get-functional` in your terminal  
